...
private val coroutinesUseCases = UseCaseCategory(
...
private val channelsUseCases = UseCaseCategory(
    "Channels Use Cases",
    listOf(
        UseCase(
            "Channels Use Case 1",
...
private val flowUseCases = UseCaseCategory(
    "Flow Use Cases",
    listOf(
        UseCase(
            "Flow Use Case 1",
...
val useCaseCategories = listOf(coroutinesUseCases, channelsUseCases, flowUseCases)